...
public class MjpegView1 extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public class MjpegViewThread extends Thread {
        ...
        private Rect destRect(int bmw, int bmh) {
            int tempx;
            int tempy;
            if (displayMode == MjpegView1.SIZE_STANDARD) {
                tempx = (dispWidth / 2) - (bmw / 2);
                tempy = (dispHeight / 2) - (bmh / 2);
                return new Rect(tempx, tempy, bmw + tempx, bmh + tempy);
            }
            if (displayMode == MjpegView1.SIZE_BEST_FIT) {
            ...
            if (displayMode == MjpegView1.SIZE_FULLSCREEN) return new Rect(0, 0, dispWidth, dispHeight);
            return null;
        }
    ...
    private void init(Context context) {
        ...
        ovlPos = MjpegView1.POSITION_LOWER_RIGHT;
        displayMode = MjpegView1.SIZE_STANDARD;
        dispWidth = getWidth();
    ...
    public MjpegView1(Context context, AttributeSet attrs) { super(context, attrs); init(context); }
    ...
    public MjpegView1(Context context) { super(context); init(context); }
